...
namespace Connexon.App_Code {
    ...
    public partial class ConnX : global::System.Data.DataSet {
        ...
        public partial class CategoryDataTable : global::System.Data.TypedTableBase<CategoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CategoryRow AddCategoryRow(string Category, string Image) {
...
namespace Connexon.App_Code.ConnXTableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Category] ([Category], [Image]) VALUES (@Category, @Image)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Category] SET [Category] = @Category, [Image] = @Image WHERE (([Cat" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CategoryID, Category, Image FROM dbo.Category";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Category, Image\r\nFROM            Category";
        ...
        public virtual int Fill(ConnX.CategoryDataTable dataTable) {
        ...
        public virtual ConnX.CategoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ConnX.CategoryDataTable dataTable = new ConnX.CategoryDataTable();
        ...
        public virtual int FillCatTable(ConnX.CategoryDataTable dataTable) {
        ...
        public virtual ConnX.CategoryDataTable GetCatData() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            ConnX.CategoryDataTable dataTable = new ConnX.CategoryDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ConnX.CategoryDataTable dataTable) {
        ...
        public virtual int Insert(string Category, string Image) {
            if ((Category == null)) {
        ...
        public virtual int Update(string Category, string Image, int Original_CategoryID) {
            if ((Category == null)) {
                throw new global::System.ArgumentNullException("Category");
            }
            else {
