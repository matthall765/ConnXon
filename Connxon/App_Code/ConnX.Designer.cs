...
namespace Connexon.App_Code {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("ConnX")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class ConnX : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected ConnX(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        private void InitClass() {
            this.DataSetName = "ConnX";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ConnX.xsd";
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Category, string Image_Small, string Image_Large, string Brand, string Series, string Model, double Price, string Description) {
        ...
        public partial class CategoriesDataTable : global::System.Data.TypedTableBase<CategoriesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CategoriesRow AddCategoriesRow(string Category, string Image, string ToolTip) {
...
namespace Connexon.App_Code.ConnXTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Products] ([Category], [Image_Small], [Image_Large], [Brand], [Serie" +
                "s], [Model], [Price], [Description]) VALUES (@Category, @Image_Small, @Image_Lar" +
                "ge, @Brand, @Series, @Model, @Price, @Description)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Products] SET [Category] = @Category, [Image_Small] = @Image_Small, [Imag" +
                "e_Large] = @Image_Large, [Brand] = @Brand, [Series] = @Series, [Model] = @Model," +
                " [Price] = @Price, [Description] = @Description WHERE (([ProductID] = @Original_" +
                "ProductID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ProductID, Category, Image_Small, Image_Large, Brand, Series, Model" +
                ", Price, Description\r\nFROM            Products";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        ProductID, Category, Image_Small, Image_Large, Brand, Series, Model" +
                ", Price, Description\r\nFROM            Products\r\nWHERE        (ProductID = @Pro)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Pro", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "ProductID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        Category, Image_Small, Image_Large, Brand, Series, Model, Price, De" +
                "scription, ProductID\r\nFROM            Products\r\nWHERE        (Category LIKE @Cli" +
                "ckedItem) OR\r\n                         (Category LIKE @HtmlClick)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ClickedItem", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "Category", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@HtmlClick", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "Category", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(ConnX.ProductsDataTable dataTable) {
        ...
        public virtual ConnX.ProductsDataTable GetProducts() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ConnX.ProductsDataTable dataTable = new ConnX.ProductsDataTable();
        ...
        public virtual int FillByID(ConnX.ProductsDataTable dataTable, int Pro) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Pro));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        public virtual ConnX.ProductsDataTable GetDataByID(int Pro) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Pro));
            ConnX.ProductsDataTable dataTable = new ConnX.ProductsDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillProductsByCategory(ConnX.ProductsDataTable dataTable, string ClickedItem, string HtmlClick) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((ClickedItem == null)) {
                throw new global::System.ArgumentNullException("ClickedItem");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(ClickedItem));
            }
            if ((HtmlClick == null)) {
                throw new global::System.ArgumentNullException("HtmlClick");
            }
            else {
                this.Adapter.SelectCommand.Parameters[1].Value = ((string)(HtmlClick));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual ConnX.ProductsDataTable GetProductsDataCategory(string ClickedItem, string HtmlClick) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((ClickedItem == null)) {
                throw new global::System.ArgumentNullException("ClickedItem");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ConnX.ProductsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ConnX dataSet) {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ConnX.CategoriesDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ConnX.CategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ConnX.CategoriesDataTable dataTable = new ConnX.CategoriesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ConnX.CategoriesDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(ConnX dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._categoriesTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(ConnX dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._categoriesTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(ConnX dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._productsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(ConnX dataSet) {
            if ((dataSet == null)) {
